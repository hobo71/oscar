@extends('layouts.app') 
@section('content')
<form enctype="multipart/form-data" action="{{ action('ClienteController@store') }}" method="POST" role="form">
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								{!! Form::label('apellido') !!} {!! Form::text('apellido', null, ['class'=>'form-control']) !!}
							</div>
							<div class="col-md-3">
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								{!! Form::label('domicilio_temporal') !!} {!! Form::text('domicilio_temporal', null, ['class'=>'form-control']) !!}
							</div>
							<div class="col-md-2">
						...
						<div class="form-group row">
							<div class="col-md-1">
								{!! Form::label('vip') !!} {!! Form::checkbox('vip', null, null, ['class'=>'form-control']) !!}
							</div>
							<!-- /.col-md-4 -->
							<div class="col-md-11">
