...
<form class="form-horizontal col-xl-3 col-lg-4 col-md-6 col-sm-8 col-xs-12" role="form" method="POST" action="{{ url('/register') }}">
    {{ csrf_field() }}
    <div class="card border-0" style="overflow: hidden;">
            <div class="card-body pb-0">
                    <h1 class="py-4 px-3 justify-content-between    d-flex align-items-center">
                        ...
                        <h4 class="card-title  text-warning px-3 ">Registrate</h4>
                        <hr>
